    ...
    methods:{
        ...
        changeMobileNext(){
            if(this.changeMobilePage == 0){
                ...
                this.$axios.post('/common/sms_verify',{verify_code:this.changeMobile.verify_code}).then(res=>{
                    if (res.data === 'OK') {
        ...
        vcode_success(){
            ...
            this.$axios.post('/common/sendsms',{"phone": this.changeMobile.new_mobile}).then(res=>{
                if(res.data === 'OK'){
